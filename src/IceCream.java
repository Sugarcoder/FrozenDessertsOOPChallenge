...
public class IceCream extends FrozenYogurt {

    private String mainIngredient;
    private String flavor;
    private String coneName;

    public IceCream(String coneName, double conePrice, String flavor, int topping, double toppingPrice, String mainIngredient) {
    ...
    public void orderFrozenDessert() {
        System.out.println("The main ingredient in ice cream is " + mainIngredient);
